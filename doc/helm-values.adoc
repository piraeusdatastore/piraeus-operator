...
Default:: `k8s.gcr.io/sig-storage/snapshot-controller:v3.0.2`
Valid values:: image ref
...
=== `csi.pluginImage`
Default:: `quay.io/piraeusdatastore/piraeus-csi:v0.11.0`
Valid values:: image ref
...
Default:: `quay.io/piraeusdatastore/piraeus-server:v1.11.0`
Valid values:: image ref
...
Default:: `quay.io/piraeusdatastore/drbd9-bionic:v9.0.26`
Valid values:: image ref
