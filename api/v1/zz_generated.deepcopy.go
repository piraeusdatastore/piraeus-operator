...
func (in *ClusterReference) DeepCopyInto(out *ClusterReference) {
	*out = *in
	if in.CAReference != nil {
		in, out := &in.CAReference, &out.CAReference
		*out = new(CAReference)
		(*in).DeepCopyInto(*out)
	}
...
func (in *EvacuationStrategy) DeepCopyInto(out *EvacuationStrategy) {
	*out = *in
	out.AttachedVolumeReattachTimeout = in.AttachedVolumeReattachTimeout
	out.UnattachedVolumeAttachTimeout = in.UnattachedVolumeAttachTimeout
}
...
func (in *LinstorClusterSpec) DeepCopyInto(out *LinstorClusterSpec) {
	*out = *in
	...
	if in.AffinityController != nil {
		in, out := &in.AffinityController, &out.AffinityController
		*out = new(DeploymentComponentSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.NFSServer != nil {
...
func (in *LinstorClusterStatus) DeepCopyInto(out *LinstorClusterStatus) {
	*out = *in
	...
	if in.ScheduledSatellites != nil {
		in, out := &in.ScheduledSatellites, &out.ScheduledSatellites
		*out = new(int32)
		**out = **in
	}
	if in.RunningSatellites != nil {
		in, out := &in.RunningSatellites, &out.RunningSatellites
		*out = new(int32)
		**out = **in
	}
	if in.NumberOfVolumes != nil {
		in, out := &in.NumberOfVolumes, &out.NumberOfVolumes
		*out = new(int32)
		**out = **in
	}
	if in.NumberOfSnapshots != nil {
		in, out := &in.NumberOfSnapshots, &out.NumberOfSnapshots
		*out = new(int32)
		**out = **in
	}
	if in.TotalCapacityBytes != nil {
		in, out := &in.TotalCapacityBytes, &out.TotalCapacityBytes
		*out = new(int64)
		**out = **in
	}
	if in.FreeCapacityBytes != nil {
		in, out := &in.FreeCapacityBytes, &out.FreeCapacityBytes
		*out = new(int64)
		**out = **in
	}
}
...
func (in *LinstorNodeProperty) DeepCopyInto(out *LinstorNodeProperty) {
	*out = *in
	...
	if in.ExpandFrom != nil {
		in, out := &in.ExpandFrom, &out.ExpandFrom
		*out = new(LinstorNodePropertyExpandFrom)
		**out = **in
	}
}
...
func (in *LinstorNodePropertyExpandFrom) DeepCopyInto(out *LinstorNodePropertyExpandFrom) {
	*out = *in
	out.LinstorNodePropertyValueFrom = in.LinstorNodePropertyValueFrom
}
...
func (in *LinstorSatelliteConfigurationSpec) DeepCopyInto(out *LinstorSatelliteConfigurationSpec) {
	*out = *in
	...
	if in.EvacuationStrategy != nil {
		in, out := &in.EvacuationStrategy, &out.EvacuationStrategy
		*out = new(EvacuationStrategy)
		**out = **in
	}
	if in.PodTemplate != nil {
...
func (in *LinstorSatelliteStatus) DeepCopyInto(out *LinstorSatelliteStatus) {
	*out = *in
	...
	if in.StorageProviders != nil {
		in, out := &in.StorageProviders, &out.StorageProviders
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.DeviceLayers != nil {
		in, out := &in.DeviceLayers, &out.DeviceLayers
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *LinstorStoragePool) DeepCopyInto(out *LinstorStoragePool) {
	*out = *in
	...
	if in.ZfsPool != nil {
		in, out := &in.ZfsPool, &out.ZfsPool
		*out = new(LinstorStoragePoolZfs)
		(*in).DeepCopyInto(*out)
	}
	if in.ZfsThinPool != nil {
		in, out := &in.ZfsThinPool, &out.ZfsThinPool
		*out = new(LinstorStoragePoolZfs)
		(*in).DeepCopyInto(*out)
	}
	if in.Source != nil {
...
func (in *LinstorStoragePoolLvm) DeepCopyInto(out *LinstorStoragePoolLvm) {
	*out = *in
	if in.PhysicalVolumeCreateArguments != nil {
		in, out := &in.PhysicalVolumeCreateArguments, &out.PhysicalVolumeCreateArguments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.VolumeGroupCreateArguments != nil {
		in, out := &in.VolumeGroupCreateArguments, &out.VolumeGroupCreateArguments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *LinstorStoragePoolLvmThin) DeepCopyInto(out *LinstorStoragePoolLvmThin) {
	*out = *in
	...
	if in.LogicalVolumeCreateArguments != nil {
		in, out := &in.LogicalVolumeCreateArguments, &out.LogicalVolumeCreateArguments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *LinstorStoragePoolZfs) DeepCopyInto(out *LinstorStoragePoolZfs) {
	*out = *in
	if in.ZpoolCreateArguments != nil {
		in, out := &in.ZpoolCreateArguments, &out.ZpoolCreateArguments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
